...
///
  ...
  <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: 300, bgcolor: 'background.paper', boxShadow: 24, p: 4 }}>
    ...
    <h1></h1>
        ...
        <div className='navbar-pagina-medici'>
        <Navbar/>
        </div>
      <div className='layout-pagina-medici'>
